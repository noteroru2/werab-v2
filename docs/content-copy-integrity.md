...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `/รับซื้อโน๊ตบุ๊ค/` | `docs/content-approved/notebook.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อคอม/` | `docs/content-approved/computer.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อแมคบุ๊ค/` | `docs/content-approved/macbook.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อไอโฟน/` | `docs/content-approved/iphone.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อไอแพด/` | `docs/content-approved/ipad.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อกล้อง/` | `docs/content-approved/camera.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อลำโพง/` | `docs/content-approved/speaker.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อซากคอมพิวเตอร์/` | `docs/content-approved/computer-scrap.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อ-server/` | `docs/content-approved/server.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อ/` | `docs/content-approved/main-buyback.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
...
| `/รับซื้อโน๊ตบุ๊คอุบล-notebook-laptop-จ/` | `docs/content-approved/local-notebook-ubon.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อคอม-อุดรธานี/` | `docs/content-approved/local-computer-udon.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อคอม-ขอนแก่น/` | `docs/content-approved/local-computer-khonkaen.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-บุรีรัม/` | `docs/content-approved/local-notebook-buriram.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-เลย/` | `docs/content-approved/local-notebook-loei.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโทรศัพท์มือถือ-จ/` | `docs/content-approved/local-phone-regional-isan.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อมือถือ-อุบล/` | `docs/content-approved/local-mobile-ubon.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-ชัยภูมิ/` | `docs/content-approved/local-notebook-chaiyaphum.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อไอโฟน-มหาสารคาม/` | `docs/content-approved/local-iphone-mahasarakham.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-สกลนคร/` | `docs/content-approved/local-notebook-sakonnakhon.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-นครพนม/` | `docs/content-approved/local-notebook-nakhonphanom.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
| `/รับซื้อโน๊ตบุ๊ค-นครราชส/` | `docs/content-approved/local-notebook-korat.md` | `INDEX` | 200 | `index,follow` | `self` | `YES` | PASS | PASS | PASS | 1 | **PASS** | 0 | 0 | 0 | 5/5 (PASS) | PASS | PASS | **PASS_EXACT** |
...
Implemented Hash: ed78050f79641b87687c6c65fc59cd31ec776837ad4d37ad8fcc3648daa16c32
Status:           PASS_EXACT

Path: /รับซื้อ-server/
Approved Hash:    148c0cb9ce5dea9342695123d03f06ac4a810502e8d5bfad308e6c41df09a38c
Implemented Hash: 148c0cb9ce5dea9342695123d03f06ac4a810502e8d5bfad308e6c41df09a38c
Status:           PASS_EXACT
