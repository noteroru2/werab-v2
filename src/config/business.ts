...
export const BUSINESS_FACTS = {
  ...
  VERIFIED: {
    ...
    valueProps: [
      'ประเมินราคาตามสภาพจริง โปร่งใส ตรงไปตรงมา',
      'ล้างข้อมูลส่วนบุคคล (Data Privacy) อย่างปลอดภัยตามมาตรฐาน',
      'บริการรับซื้อและนัดรับสะดวก รวดเร็ว ปลอดภัย',
      'ให้คำปรึกษาและเช็กราคากลางเบื้องต้นได้ฟรีก่อนตัดสินใจขาย'
    ],
